...
import argparse
import os
# os.environ["CUDA_VISIBLE_DEVICCES"]='6'
if __name__ == '__main__':
    ...
    # 1.2. Paths
    parser.add_argument('-dataset_path', default='/home/data/lrd/zgp/abaw/affwild2_test/test', type=str,
                        help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob
    parser.add_argument('-load_path', default='/home/data/lrd/zgp/abaw/abaw5_preprocessing/load', type=str,
                        help='The path to load the trained models, such as the backbone.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-save_path', default='/home/data/lrd/zgp/abaw/ABAW6/save', type=str,
                        help='The path to save the trained models ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/home/data/lrd/zgp/abaw/ABAW6', type=str,
    ...
    parser.add_argument('-stamp', default='0315_wy_vmv_100ep_bs16', type=str, help='To indicate different experiment instances')
    ...
    parser.add_argument('-modality', default=["video","mfcc","vggish","VA_continuous_label"
        ])
    ...
    parser.add_argument('-emotion', default="arousal",
    ...
    parser.add_argument('-model_name', default="CAN", help='LFAN, CAN')
    ...
    parser.add_argument('-window_length', default=200, type=int, help='The length in point number to windowing the data.')
