...
config = {
    ...
    "extract_mfcc": 1, # Extract MFCC.
    "mfcc_folder": "mfcc",
    "mfcc_config_file": "opensmile_mfcc.conf",

    "extract_egemaps": 1, # This one can be really slow to extract.
    ...
    "root_directory": "/home/data/wyq/ABAW_VA/ABAW2-test/ABAW2-EXP/au_dataset_test",

    # Set to the same as root_directory so that the intermediate data will also be saved in here.
    "output_root_directory": "/home/data/wyq/ABAW_VA/ABAW2-test/ABAW2-EXP/au_dataset_test",

    # Put all the model state dict here, such as Vosk, and opensmile config file.
    "load_directory": "/home/data/lrd/zgp/abaw/abaw5_preprocessing/load",

    # The VA task.
    "task": task,

    # Raw videos from the ABAW authors.
    "raw_data_folder": "raw_video",
    ...
    "speech_model": {
        ...
        "path": "/home/data/lrd/zgp/abaw/abaw5_preprocessing/load/vosk-model-en-us-0.22"
    },
}
